...
namespace Checkers.Logic
{
    ...
    public enum eNumOfTools { NumOfToolsInSmallBoard = 6, NumOfToolsInMediumBoard = 12, NumOfToolsInBigBoard = 20 }
    ...
    public class Player
    {
        ...
        private eNumOfTools m_NumOfTools;
        ...
        public Player(eTypeOfBoard i_SizeOfBoard, eOwnerPlayer i_PlayerNum, ePlayerType i_PlayerType = ePlayerType.Computer, string i_Name = "Comp")
        {
            ...
            m_PlayerTools = new GameTool[(short)m_NumOfTools];
            m_Name = i_Name;
            m_Type = i_PlayerType;
            m_Score = 0;
        ...
        private eNumOfTools NumOfTools(eTypeOfBoard i_SizeOfBoard)
        {
            //deals with exist eTypeOfBoard's types.
            //for new size - this func needs to be update
            eNumOfTools numOfTools;

            if (i_SizeOfBoard == eTypeOfBoard.Small)
            {
                numOfTools = eNumOfTools.NumOfToolsInSmallBoard;
            }
            else if (i_SizeOfBoard == eTypeOfBoard.Medium)
            {
                numOfTools = eNumOfTools.NumOfToolsInMediumBoard;
            }
            else
            {
                numOfTools = eNumOfTools.NumOfToolsInBigBoard;
            }
