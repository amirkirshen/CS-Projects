...
namespace Ex01_04
{
    class Program
    {
        ...
        public static bool IsValidString(StringBuilder i_String)
        {
            ...
            if (stringLength != k_stringMaxSize)
            {
                Console.WriteLine("Invalid input! String length should be 8");
                isValid = false;
            }

            else if (!IsStringContainOnlyLetters(i_String) && !IsStringContainOnlyDigits(i_String))
            {
        ...
        public static bool IsStringContainOnlyLetters(StringBuilder i_String)
        {
            ...
            for (short index = 0; index < k_stringMaxSize; index++)
            {
